...
constraintGroups(
 ...
 ;( -----	---------- )
  ( "virtuosoDefaultExtractorSetup"	nil
    ...
    interconnect(
     ( validLayers   (substrate2 gate polycutoxide PWdummy Nwell  Oxide  Poly Nimp Pimp  Cont  Metal1  Via1  Metal2  Via2  Metal3  Via3  Metal4  Via4  Metal5  Via5  Metal6  Via6  Metal7  Via7  Metal8  Via8  Metal9  Via9  Metal10  Via10  Metal11  ) )
    ) ;interconnect
...
;      ( minExtension               "Poly"	"Oxide"		0.12   'ref "POLY.E.1.DFM, POLY.E.2.DFM")
 ...
 ;( -----                       ---------     )
  ...
  ( "minPRBoundaryInteriorHaloCG" nil nil 'and
     spacings(
 ...
 ;( -----	---------- )
  ( "foundry"	nil
     memberConstraintGroups(
         "minPRBoundaryInteriorHaloCG" "minProtrusionNumCutCG"
     ) ;memberCG
...
;      ( minEnclosure               "Oxide_thk"	"Poly"		0.18  'ref  "OXIDETHK.E.2"  'description  "Minimum Thick Active Area enclosure of 1.8V Poly Gate" )
     ( minExtensionDistance               "Oxide_thk"	"Poly"		0.18  'ref  "OXIDETHK.E.2"  'description  "Minimum Thick Active Area enclosure of 1.8V Poly Gate" )
...
;      ( minEnclosure               "Nimp"	"sd_ndiff"	 0.07 'ref  "NIMP.E.1"  'description  "Minimum N+ Implant to N+ Active Area Enclosure" )
     ( minExtensionDistance               "Nimp"	"sd_ndiff"	 0.07 'ref  "NIMP.E.1"  'description  "Minimum N+ Implant to N+ Active Area Enclosure" )
...
;      ( minEnclosure               "Pimp"	"sd_pdiff"	0.07  'ref  "PIMP.E.1"  'description  "Minimum P+ Implant to P+ Active Area Enclosure" )
     ( minExtensionDistance               "Pimp"	"sd_pdiff"	0.07  'ref  "PIMP.E.1"  'description  "Minimum P+ Implant to P+ Active Area Enclosure" )
...
tcCreateDeviceClass( "layout" "cdsGuardRing"
    ; class parameters
    ( (vfoGRImpl "vfoGuardRing") (modelLpp (quote ("y1" "drawing"))) (tmpLpp (quote ("y0" "drawing"))) 
...
tcDeclareDevice( "layout" "cdsGuardRing" "pring"
    ...
    ( (contAlignment "") (yDiffEnclCont 0.030000) (xDiffEnclCont 0.030000) 
      (yMetEnclCont 0.030000) (xMetEnclCont 0.030000) (yContSpacing 0.060000) 
      (xContSpacing 0.060000) (yContWidth 0.060000) (xContWidth 0.060000) 
      (enclosingLayers "(((\\\"Pimp\\\" \\\"drawing\\\") 0.01 ?coverInterior nil ?useEncLayer t) ((\\\"Nwell\\\" \\\"drawing\\\") 0.06 ?coverInterior nil ?useEncLayer t))") (shapeData "nil") (shapeType "none") 
...
tcDeclareDevice( "layout" "cdsGuardRing" "nring"
    ...
    ( (contAlignment "") (yDiffEnclCont 0.030000) (xDiffEnclCont 0.030000) 
      (yMetEnclCont 0.030000) (xMetEnclCont 0.030000) (yContSpacing 0.060000) 
      (xContSpacing 0.060000) (yContWidth 0.060000) (xContWidth 0.060000) 
      (enclosingLayers "(((\\\"Nimp\\\" \\\"drawing\\\") 0.01 ?coverInterior nil ?useEncLayer t))") (shapeData "nil") (shapeType "none") 
      (decompositionMode "fill45-path-poly") (hide_keepouts t) (fillStyle "distribute") 
      (fillClass "vfoSfFillSafe") (debug 0) (do_something t) 
      (formalVersion 0) (keepOuts (quote nil)) (removeCornerContacts 
    (quote nil)) )
